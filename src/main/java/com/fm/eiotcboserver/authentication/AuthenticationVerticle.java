package com.fm.eiotcboserver.authentication;

import com.fm.eiotcboserver.commons.RequestUtils;
...
public class AuthenticationVerticle extends Verticle {
   ...
   public void start() {
      ...
      vertx.createHttpServer().requestHandler(matcher).listen(9999);

      container.logger().info(" ... EIoTC BackOffice Authentication server started, listening on port: 9999");
   }
